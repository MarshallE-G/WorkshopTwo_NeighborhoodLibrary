...
public class Main {
    ...
    public void availableBooksMenu(String conditional, int bookCounter, String name) {
        Scanner scanner = new Scanner(System.in);
        ...
        System.out.println("\n# of Available books: " + bookCounter + "\n");
        ...
        conditional = scanner.next();
        int iDToCheckOut;
        switch (conditional) {
            case "1":
                // Ask for user's name
                System.out.println("What is your name? ");
                name = scanner.next(); // For some reason scanner.nextLine() "skipped" this line and went to line 93.
